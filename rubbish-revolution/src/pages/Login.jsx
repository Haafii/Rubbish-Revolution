  ...
  const LoginForm = () => {
    return(
       <div className="bg-primary rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-out">
             <h2 className='p-3 text-3xl font-bold text-blue-400'>Rubbish Revolution</h2>
             <div className="inline-block border-[1px] justify-center w-20 border-gray-400 border-solid"></div>
             ...
             <div className='flex flex-col items-center justify-center'>
              ...
              <button className='rounded-2xl m-2 text-white bg-sky-500 w-2/5 px-4 py-2 shadow-md hover:text-secondary hover:bg-sky-600 transition duration-200 ease-in'>
                Sign In
              </button>
             </div>
             <div className="inline-block border-[1px] justify-center w-20 border-gray-400 border-solid"></div>
     ...
     return(
        <div className="bg-primary text-black rounded-2xl shadow-2xl  flex flex-col w-full  md:w-1/3 items-center max-w-4xl transition duration-1000 ease-in">
             ...
             <input type='text' className='rounded-2xl px-2 py-1 w-4/5 md:w-full border-[1px]  m-1 focus:shadow-md  focus:outline-none focus:ring-0' placeholder='Name'></input>
              ...
              <button className='rounded-2xl m-4 text-white bg-sky-500 w-3/5 px-4 py-2 shadow-md hover:text-secondary hover:bg-sky-600 transition duration-200 ease-in'>
                Sign Up
              </button>
             </div>
             <div className="inline-block border-[1px] justify-center w-20 border-white border-solid"></div>
